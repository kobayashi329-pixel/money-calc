...
export const GUIDES: Guide[] = [
  {
    ...
    title: "年収500万円の手取りは約390万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収500万の手取り",
    description:
      "年収500万円の手取りは約390万円・月約32万円。所得税・住民税・社会保険料の内訳とボーナスの手取り、手取りを増やす方法を解説します。",
    category: "kyuyo",
  ...
  },
  {
    ...
    title: "年収400万円の手取りは約317万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収400万の手取り",
    description:
      "年収400万円の手取りは約317万円・月約26万円。所得税・住民税・社会保険料の内訳・ボーナス手取りまでわかりやすく解説します。",
    category: "kyuyo",
    targets: ["tedori", "bonus-tedori"],
    related: ["nenshu-350man-tedori", "nenshu-500man-tedori", "bonus-nanwari"],
    status: "live",
    updated: "2026年7月3日",
    emoji: "💴",
  },
  {
    ...
    title: "年収600万円の手取りは約463万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収600万の手取り",
    description:
      "年収600万円の手取りは約463万円・月約38万円。所得税・住民税・社会保険料の内訳とボーナスの手取り、節税の選択肢を解説します。",
    category: "kyuyo",
    targets: ["tedori", "bonus-tedori"],
  ...
  },
  {
    ...
    title: "年収700万円の手取りは約531万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収700万の手取り",
    description:
      "年収700万円の手取りは約531万円・月約44万円。所得税・住民税・社会保険料の内訳・ボーナス手取りと、節税の選択肢を解説します。",
    category: "kyuyo",
    targets: ["tedori", "bonus-tedori"],
    related: ["nenshu-600man-tedori", "nenshu-1000man-tedori", "bonus-nanwari"],
    status: "live",
    updated: "2026年7月3日",
    emoji: "💴",
  },
  ...
  },
  {
    ...
    title: "年収1000万円の手取りは約727万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収1000万の手取り",
    description:
      "年収1000万円の手取りは約727万円・月約60万円。所得税・住民税・社会保険料の内訳・ボーナス手取りと、負担を抑える方法を解説します。",
    category: "kyuyo",
    targets: ["tedori", "bonus-tedori"],
    related: ["nenshu-700man-tedori", "nenshu-600man-tedori", "bonus-nanwari"],
    status: "live",
    updated: "2026年7月3日",
    emoji: "💴",
  },
  ...
  },
  {
    ...
    title: "年収300万円の手取りは約241万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収300万の手取り",
    description:
      "年収300万円の手取りは約240万円・月約20万円。所得税・住民税・社会保険料の内訳・ボーナス手取りをわかりやすく解説します。",
    category: "kyuyo",
    targets: ["tedori", "bonus-tedori"],
    related: ["nenshu-350man-tedori", "nenshu-400man-tedori", "bonus-nanwari"],
    status: "live",
    updated: "2026年7月3日",
    emoji: "💴",
  },
  {
    ...
    category: "kyuyo",
    targets: ["bonus-tedori", "tedori"],
    related: ["nenshu-500man-tedori", "bonus-nanwari", "bonus-zeikin"],
    status: "live",
    updated: "2026年6月23日",
    emoji: "🎁",
  },
  {
    slug: "bonus-nanwari",
    title: "ボーナスは手取り何割？額面との違いと引かれるものを解説",
    shortTitle: "ボーナスは手取り何割",
    description:
      "ボーナスの手取りは額面のおよそ8割。前月給与が高いほど源泉所得税の率が上がり、手取り率は下がります。早見表つきで解説します。",
    category: "kyuyo",
    targets: ["bonus-tedori", "tedori"],
    related: ["bonus-tedori", "bonus-zeikin"],
    status: "live",
    updated: "2026年7月2日",
    emoji: "🎉",
  },
  {
    slug: "bonus-zeikin",
    title: "ボーナスから引かれる税金・社会保険料はいくら？内訳を解説",
    shortTitle: "ボーナスの税金",
    description:
      "ボーナスから引かれるのは社会保険料と所得税（源泉徴収）。住民税が引かれない理由や、扶養で税額が変わる仕組みを解説します。",
    category: "kyuyo",
    targets: ["bonus-tedori", "shahoken"],
    related: ["bonus-tedori", "bonus-nanwari"],
    status: "live",
    updated: "2026年7月2日",
    emoji: "🧾",
  },
  ...
  },
  {
    ...
    title: "年収350万円の手取りは約279万円｜月収・ボーナス・税金【2026年】",
    shortTitle: "年収350万の手取り",
    description:
      "年収350万円の手取りは約279万円・月約23万円。所得税・住民税・社会保険料の内訳と、手取りを増やす方法をわかりやすく解説します。",
    category: "kyuyo",
    targets: ["tedori", "bonus-tedori"],
    related: ["nenshu-300man-tedori", "nenshu-400man-tedori", "nenshu-tedori-ichiran", "bonus-nanwari"],
    status: "live",
    updated: "2026年7月3日",
    emoji: "💴",
  },
  {
    ...
    title: "年収450万円の手取りは約355万円｜月収・ボーナス・税金【2026年】",
  ...
  },
  {
    ...
    title: "年収550万円の手取りは約427万円｜月収・ボーナス・税金【2026年】",
  ...
  },
  {
    ...
    title: "年収650万円の手取りは約499万円｜月収・ボーナス・税金【2026年】",
